...
trait Binder[V <: VariableExpr,T,-In,+Out] extends (In => Out) with Serializable

//trait HBinder[V <: VariableExpr,T,-In,+Out] extends (In => Out) with Serializable

object Binder extends BindingImplicits {
  def nonBinder[V <: VariableExpr, T, E]: Binder[V,T,E,E] =
    new Binder[V,T,E,E] { def apply(v1: E) = v1 }

  def instance[V <: VariableExpr, T, In, Out](f: In => Out): Binder[V,T,In,Out] = new Binder[V,T,In,Out] {
    def apply(v1: In): Out = f(v1)
  }
}

//object HBinder {
//  implicit def HNilBinder[V <: VariableExpr, T]: HBinder[V, T, HNil,HNil] =
//    new HBinder[V,T,HNil,HNil] {
//      def apply(v1: HNil) = v1
//    }
//
//  implicit def HListBinder[V <: VariableExpr, T, H1 <: Expr, T1 <: HList, H2 <: Expr, T2 <: HList]
...
//  V <: VariableExpr, T, E1 <: Expr,E2 <: Expr, Repr1 <: HList, Repr2 <: HList
//  ]
...
//  }
//
//  implicit def HNilBinder[V <: VariableExpr, T]: Binder[V, T, HNil,HNil] =
...
//  }
  ...
  implicit def PhysicalCollectionBinder[V <: VariableExpr,T,C[_,_],K,R]: Binder[V,T,PhysicalCollection[C,K,R],PhysicalCollection[C,K,R]] =
...
//  V1 <: VariableExpr, V2 <: VariableExpr, T1, T2, E1 <: VariableExpr, E2 <: VariableExpr, E3 <: VariableExpr
...
//  V1 <: VariableExpr, V2 <: VariableExpr, V3 <: VariableExpr, T1, T2, T3,
//  E1 <: VariableExpr, E2 <: VariableExpr, E3 <: VariableExpr, E4 <: VariableExpr
...
//    }
  ...
  implicit def BindProduct2[
    V1 <: VariableExpr, V2 <: VariableExpr, T1, T2, E1 <: VariableExpr, E2 <: VariableExpr, E3 <: VariableExpr
  ](implicit bind1: Binder[V1, T1, E1, E2], bind2: Binder[V2, T2, E2, E3]): Binder[ProductVariableExpr[V1 :: V2 :: HNil], (T1, T2), E1, E3] =
    new Binder[ProductVariableExpr[V1::V2::HNil], (T1, T2), E1, E3] {
      def apply(v1: E1) = bind2(bind1(v1))
    }
  ...
  E1 <: VariableExpr, E2 <: VariableExpr, E3 <: VariableExpr, E4 <: VariableExpr
    ...
    bind2: Binder[V2, T2, E2, E3],
    bind3: Binder[V3, T3, E3, E4]): Binder[ProductVariableExpr[V1 :: V2 :: V3 :: HNil], (T1, T2, T3), E1, E4] =
    new Binder[ProductVariableExpr[V1 :: V2 :: V3 :: HNil], (T1, T2, T3), E1, E4] {
      def apply(v1: E1) = bind3(bind2(bind1(v1)))
    }
}
...
trait Priority1BindingImplicits extends Priority0BindingImplicits {
  ...
  implicit def AddBinder[V <: VariableExpr, T, L <: RingExpr, R <: RingExpr, L1 <: RingExpr, R1 <: RingExpr]
  ...
  implicit def MultiplyBinder[V <: VariableExpr, T, L <: RingExpr, R <: RingExpr, L1 <: RingExpr, R1 <: RingExpr]
  ...
  implicit def DotBinder[V <: VariableExpr, T, L <: RingExpr, R <: RingExpr, L1 <: RingExpr, R1 <: RingExpr]
  ...
  implicit def JoinBinder[V <: VariableExpr, T, L <: RingExpr, R <: RingExpr, L1 <: RingExpr, R1 <: RingExpr]
  ...
  implicit def NotBinder[V <: VariableExpr, T, R <: RingExpr, R1 <: RingExpr]
  ...
  implicit def NegateBinder[V <: VariableExpr, T, R <: RingExpr, R1 <: RingExpr]
  ...
  implicit def SumBinder[V <: VariableExpr, T, R <: RingExpr, R1 <: RingExpr]
  ...
  implicit def GroupBinder[V <: VariableExpr, T, R <: RingExpr, R1 <: RingExpr]
  ...
  implicit def SngBinder[V <: VariableExpr, T, K <: KeyExpr, R <: RingExpr, K1 <: KeyExpr, R1 <: RingExpr]
  ...
  implicit def EqualsPredicateBinder[V <: VariableExpr, T, K1 <: KeyExpr, K2 <: KeyExpr, K1B <: KeyExpr, K2B <: KeyExpr]
  ...
  implicit def IntPredicateBinder[V <: VariableExpr, T, K1 <: KeyExpr, K2 <: KeyExpr, K1B <: KeyExpr, K2B <: KeyExpr]
  ...
  implicit def ToRingBinder[V <: VariableExpr, T, R <: Expr, R1 <: Expr]
  ...
  implicit def BoxedRingBinder[V <: VariableExpr, T, R <: Expr, R1 <: RingExpr]
  ...
  implicit def LabelBinder[V <: VariableExpr, T, R <: RingExpr, R1 <: RingExpr]
  ...
  implicit def ProductKeyBinder[V <: VariableExpr,T,C <: HList, CR <: HList]
  (implicit resolve: Binder[V,T,C,CR], lub: LUBConstraint[CR,KeyExpr]): Binder[V,T,ProductKeyExpr[C],ProductKeyExpr[CR]] =
    new Binder[V,T,ProductKeyExpr[C],ProductKeyExpr[CR]] {
      def apply(v1: ProductKeyExpr[C]) = ProductKeyExpr(resolve(v1.exprs))
    }

  implicit def ProductRingBinder[V <: VariableExpr,T,C <: HList, CR <: HList]
  (implicit resolve: Binder[V,T,C,CR], lub: LUBConstraint[CR,RingExpr]): Binder[V,T,ProductRingExpr[C],ProductRingExpr[CR]] =
    new Binder[V,T,ProductRingExpr[C],ProductRingExpr[CR]] {
      def apply(v1: ProductRingExpr[C]) = ProductRingExpr(resolve(v1.exprs))
    }

  implicit def ProductVariableBinder[V <: VariableExpr,T,C <: HList, CR <: HList]
  (implicit bind: Binder[V,T,C,CR], lub: LUBConstraint[CR,VariableExpr]): Binder[V,T,ProductVariableExpr[C],ProductVariableExpr[CR]] =
    new Binder[V,T,ProductVariableExpr[C],ProductVariableExpr[CR]] {
      def apply(v1: ProductVariableExpr[C]) = ProductVariableExpr(bind(v1.exprs))
    }

  implicit def HNilBinder[V <: VariableExpr,T]: Binder[V,T,HNil,HNil] = Binder.nonBinder[V,T,HNil]
...
//  V <: VariableExpr, T, V1 <: VariableExpr, V2 <: VariableExpr,
//  V1B <: VariableExpr, V2B <: VariableExpr
...
//  V <: VariableExpr, T, V1 <: VariableExpr, V2 <: VariableExpr, V3 <: VariableExpr,
//  V1B <: VariableExpr, V2B <: VariableExpr, V3B <: VariableExpr
...
//  implicit def Tuple2KeyBinder[V <: VariableExpr, T, K1 <: KeyExpr, K2 <: KeyExpr, K1B <: KeyExpr, K2B <: KeyExpr]
...
//    }
//
//  implicit def Tuple3KeyBinder[V <: VariableExpr, T, K1 <: KeyExpr, K2 <: KeyExpr, K3 <: KeyExpr, K1B <: KeyExpr, K2B <: KeyExpr, K3B <: KeyExpr]
...
//    }
//
//  implicit def Tuple2RingBinder[V <: VariableExpr, T, K1 <: RingExpr, K2 <: RingExpr, K1B <: RingExpr, K2B <: RingExpr]
...
//    }
//
//  implicit def Tuple3RingBinder[V <: VariableExpr, T, K1 <: RingExpr, K2 <: RingExpr, K3 <: RingExpr, K1B <: RingExpr, K2B <: RingExpr, K3B <: RingExpr]
...
//  implicit def Project1RingBinder[V <: VariableExpr, T, R <: RingExpr with C1Expr, R1 <: RingExpr with C1Expr]
...
//    }
//
//  implicit def Project2RingBinder[V <: VariableExpr, T, R <: RingExpr with C2Expr, R1 <: RingExpr with C2Expr]
...
//    }
//
//  implicit def Project3RingBinder[V <: VariableExpr, T, R <: RingExpr with C3Expr, R1 <: RingExpr with C3Expr]
...
//    }
//
//  implicit def Project1KeyBinder[V <: VariableExpr, T, R <: KeyExpr with C1Expr, R1 <: KeyExpr with C1Expr]
...
//    }
//
//  implicit def Project2KeyBinder[V <: VariableExpr, T, R <: KeyExpr with C2Expr, R1 <: KeyExpr with C2Expr]
...
//    }
//
//  implicit def Project3KeyBinder[V <: VariableExpr, T, R <: KeyExpr with C3Expr, R1 <: KeyExpr with C3Expr]
...
trait BindingImplicits extends Priority1BindingImplicits {
  ...
  implicit def TypedNonBinder[V <: VariableExpr, T, T1]: Binder[V, T, TypedVariable[T1], TypedVariable[T1]] = Binder.nonBinder[V, T, TypedVariable[T1]]

  implicit def UnusedBinder1[V <: VariableExpr, T]: Binder[V, T, UnusedVariable, UnusedVariable] = Binder.nonBinder[V, T, UnusedVariable]

  implicit def UnusedBinder2[V <: VariableExpr, T]: Binder[UnusedVariable, T, V, V] = Binder.nonBinder[UnusedVariable, T, V
    ]
  /** Binding base cases - primitive expressions don't need to bind anything, variables bind iff they are untyped variables
    ...
    */
  implicit def PrimitiveKeyExprBinder[V <: VariableExpr, T, V1]: Binder[V, T, PrimitiveKeyExpr[V1], PrimitiveKeyExpr[V1]] =
    Binder.nonBinder[V, T, PrimitiveKeyExpr[V1]]

  implicit def NumericExprBinder[V <: VariableExpr, T, V1]: Binder[V, T, NumericExpr[V1],NumericExpr[V1]] =
  ...
  implicit def InfMappingBinder[V <: VariableExpr, T, K <: VariableExpr, R <: RingExpr, R1 <: RingExpr]

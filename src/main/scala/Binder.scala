...
trait Priority0BindingImplicits {
  ...
  implicit def HNilBinder[V <: VariableExpr[V], T]: Binder[V, T, HNil,HNil] =
    Binder.instance[V,T,HNil,HNil](identity[HNil])
  ...
  Binder[V,T,H1 :: T1, H2 :: T2] = Binder.instance[V,T,H1 :: T1, H2 :: T2] {
...
trait Priority1BindingImplicits extends Priority0BindingImplicits {
  ...
  implicit def PrimitiveRingExprBinder[V <: VariableExpr[V],T,V1]: Binder[V,T,PrimitiveRingExpr[V1],PrimitiveRingExpr[V1]] =
    Binder.nonBinder[V,T,PrimitiveRingExpr[V1]]
//  implicit def PrimitiveExprBinder[V <: VariableExpr[V],T,E <: PrimitiveExpr[_]]: Binder[V,T,PrimitiveExpr[_],E] =
//  new Binder[V,T,PrimitiveKeyExpr[_],E] { def apply(v1)}
...
//    new Binder[V,T,V1,TypedVariable[T]] { def apply(v1: V1): TypedVariable[T] = v1.tag[T] }
  implicit def VariableBinder[V <: UntypedVariable[V],T,V1 <: UntypedVariable[V1]](implicit ev: V1 <:< V): Binder[V,T,UntypedVariable[V1],TypedVariable[T]] =
    new Binder[V,T,UntypedVariable[V1],TypedVariable[T]] { def apply(v1: UntypedVariable[V1]): TypedVariable[T] = v1.tag[T] }

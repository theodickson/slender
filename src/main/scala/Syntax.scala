...
case class VariableRingPredicate[V <: VariableExpr, R <: RingExpr, P <: RingExpr](k: V, r: R, p: P = NumericExpr(1))
...
case class VariableExprOps[V <: VariableExpr](v: V) {
...
case class ForComprehensionBuilder[V <: VariableExpr, R <: RingExpr, P <: RingExpr](vrp: VariableRingPredicate[V,R,P]) {
...
V1 <: VariableExpr, V2 <: VariableExpr, R1 <: RingExpr, R2 <: RingExpr, P1 <: RingExpr, P2 <: RingExpr
...
object MakeExpr extends Priority3MakeExprImplicits {
...
//    }
  ...
  (implicit gen: Generic.Aux[P,PRepr],
   ...
   lub: LUBConstraint[KRepr,RingExpr]): MakeExpr[P,ProductRingExpr[KRepr]] =
  ...
  implicit def productMakeKeyExpr[P <: Product,PRepr <: HList, KRepr <: HList]
    (implicit gen: Generic.Aux[P,PRepr],
              make: HMakeExpr[PRepr,KRepr],
     lub: LUBConstraint[KRepr,KeyExpr]): MakeExpr[P,ProductKeyExpr[KRepr]] =
...
//  implicit def tuple2MakeVariableExpr[X1,X2,R1 <: VariableExpr, R2 <: VariableExpr]
...
//    }
//
//  implicit def tuple3MakeVariableExpr[X1,X2,X3,R1 <: VariableExpr, R2 <: VariableExpr, R3 <: VariableExpr]
//  (implicit recur1: MakeExpr[X1,R1], recur2: MakeExpr[X2,R2], recur3: MakeExpr[X3,R3]):
...
//    }
  implicit def productMakeVariableExpr[P <: Product,PRepr <: HList, KRepr <: HList]
  (implicit gen: Generic.Aux[P,PRepr],
   make: HMakeExpr[PRepr,KRepr],
   lub: LUBConstraint[KRepr,VariableExpr]): MakeExpr[P,ProductVariableExpr[KRepr]] =
    new MakeExpr[P,ProductVariableExpr[KRepr]] {
      def apply(v1: P): ProductVariableExpr[KRepr] = ProductVariableExpr(make(gen.to(v1)))
    }

}

trait Priority3MakeExprImplicits extends Priority2MakeExprImplicits {
...
trait Syntax {
  ...
  implicit def toVariableExprOps[X, E <: VariableExpr](x: X)(implicit make: MakeExpr[X, E]): VariableExprOps[E] = VariableExprOps(make(x))
  ...
  object For {
    def apply[V <: VariableExpr, R <: RingExpr, P <: RingExpr](vrp: VariableRingPredicate[V,R,P]):
  ...
  implicit class IfImplicit[V <: VariableExpr, R <: RingExpr, P <: RingExpr](pair: VariableRingPredicate[V,R,P]) {

...
//
//  implicit class ExprImplicits[T,E <: Expr[T,E]](e: E) {
//
//    def +[E1 <: Expr[T,E1]](e1: E1)(implicit ring: Ring[T]) = AddExpr[T,E,E1](e,e1)
//
//    def *[T1,E1 <: Expr[T1,E1],O](e1: E1)
//                                 (implicit mult: Multiply[T,T1,O]) = MultiplyExpr[T,T1,E,E1,O](e, e1)
//
//    def dot[T1,E1 <: Expr[T1,E1],O](e1: E1)
//                                   (implicit dot: Dot[T,T1,O]) = DotExpr[T,T1,E,E1,O](e, e1)
//
...
//  }
//
//  implicit class CollectionExprImplicits[C[_,_],K,R,E <: Expr[C[K,R],E]](e: E) {
//    def sum(implicit coll: Collection[C, K, R]) = SumExpr[C,K,R,E](e)
//  }
//

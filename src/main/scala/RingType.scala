...
//    case (r1:ProductRingType,r2) => ProductRingType(r1.ts.map(_.*(r2).asInstanceOf[ResolvedRingType]) : _ *) //todo ???
//    case (r1,r2:ProductRingType) => ProductRingType(r2.ts.map(r1.*(_).asInstanceOf[ResolvedRingType]) : _ *)
...
//    case (r1:ProductRingType,r2) => ProductRingType(r1.ts.map(_.resolvedDot(r2)) : _ *) //todo ???
//    case (r1,r2:ProductRingType) => ProductRingType(r2.ts.map(r1.resolvedDot(_)) : _ *)

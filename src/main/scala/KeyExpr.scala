...
trait KeyExpr[E <: Expr[E]] extends Expr[E] { self : E =>
//  def ===[K1 <: KeyExpr[K1]](k1: K1) = EqualsPredicate(this, k1)
//  def =!=[K1 <: KeyExpr[K1]](k1: K1) = NotExpr(EqualsPredicate(this, k1))
//
//  def >[K1 <: KeyExpr[K1]](k1: K1) = IntPredicate(this, k1, _ > _, ">")
//  def <[K1 <: KeyExpr[K1]](k1: K1) = IntPredicate(this, k1, _ < _, "<")

  def -->[R <: RingExpr[R]](r: R): (E,R) = (this,r)
}
